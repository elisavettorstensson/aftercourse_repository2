...
* **Design name:** Check that it includes a brief summary of the purpose, setup, and methodology of the library preparation.  
  This should include the scientific goal, experimental conditions, and key steps in the library construction protocol.
