...
* Check the run type and files: file extensions must be correct for a `Run` object (`.fastq`, `.bam`, `.cram`, etc.).  
  ...
  * **IF** the file extension is unknown (e.g., `.srf`, `.rds`, `.h5`, `.h5Seurat`), [See the *Supported File Formats* section at the end of this document for the list of accepted file extensions.](#supported-file-formats)
