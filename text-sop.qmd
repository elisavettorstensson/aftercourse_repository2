...
1. The assigned FEGA Sweden Helpdesk (HD member) releases the datasets in accordance with the recorded release date.  
   ...
   **Steps:**
   1. Go to the **FEGA Sweden Helpdesk Portal**.
   2. Locate the **pending submission** scheduled for release.
   3. Verify that it is the **correct submission**, then click the **Approve** button.
   4. A new message will appear in the Helpdesk Portal prompting approval of the related datasets.
